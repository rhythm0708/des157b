(function(){
    ...
    // Audio.
    const bgm = new Audio('audio/ambient-bg.mp3');
    const openArticleSfx = new Audio('audio/riser-3.mp3');
    const closeArticleSfx = new Audio('audio/descender-1.mp3');
    bgm.muted = true;
    bgm.loop = true;
    bgm.volume = 0.2;
    openArticleSfx.playbackRate = 1;
    closeArticleSfx.playbackRate = 2.5;
    openArticleSfx.volume = 0.2;
